...
if (remainingTime === 0) return "Phil's cake is ready!" 
if (remainingTime > 0) return "The cake is still baking!"
...
function estimatePrepTime(ingredients, timePerIngridient){
  return ingredients.length * timePerIngridient || ingredients.length * 2
}
